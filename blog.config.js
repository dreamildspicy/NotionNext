...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'dongzhenguo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dongzhenguo.cn', // 网站地址
  ...
  PRISM_THEME_PATH: 'https://npm.elemecdn.com/prism-themes/themes/prism-coy-without-shadows.css',
